inherited frmCustomerOrderSYComponent: TfrmCustomerOrderSYComponent
  Left = 36
  Top = 159
  Width = 973
  Height = 537
  Caption = 'frmCustomerOrderSYComponent'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited adt_active: TADODataSet
    CommandText = 'select * from ViewCustomerOrderComponent'
    ...
    object adt_activeIsRebate2: TStringField
      FieldName = 'IsRebate2'
      ReadOnly = True
      Size = 10
    end
