...
type
  TfrmPaymentTerms = class(TfrmDBBasicPrn)
    adt_activePaymentTermsID: TAutoIncField;
...
procedure TfrmPaymentTerms.SetData;
begin
  DM.DataSetQuery(adt_active, 'EXEC usp_GetPaymentTerms');
end;

procedure TfrmPaymentTerms.SetUI;
begin
  inherited;

end;

procedure TfrmPaymentTerms.SetAccess;
begin
  inherited;
