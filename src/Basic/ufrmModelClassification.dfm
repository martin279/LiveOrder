inherited frmModelClassification: TfrmModelClassification
  Caption = 'frmModelClassification'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited adt_active: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      'select M.Model,mc.* from ModelClassification mc'#13#10'left outer join' +
      ' Model m on mc.ModelID=m.ModelID where 0=0'
