inherited frmExchangeRate: TfrmExchangeRate
  Caption = 'frmExchangeRate'
  PixelsPerInch = 96
  TextHeight = 13
          ...
          inherited gridData: TDBGridEh
            Columns = <
              item
                ...
                Footers = <>
                Title.Caption = 'Exchange Rate ID'
                Width = 107
              end
              item
                EditButtons = <>
  ...
  inherited adt_active: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 'Select * from ExchangeRate'
  end
